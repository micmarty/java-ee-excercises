...
public class ElfNameValidator implements Validator {
    ...
    private static final String PATTERN = "^[A-Z]{1}[a-zA-Z]{1,}$";
    
    private static final String WRONG_NAME = "pl.gda.pg.eti.kask.javaee.jsf.validators.nameValidator.WRONG_NAME";

    private static final String WRONG_VALUE = "pl.gda.pg.eti.kask.javaee.jsf.validators.nameValidator.WRONG_VALUE";
